...
func FilterMap[T1 any, T2 comparable](seq iter.Seq[T1], f func(T1) T2) iter.Seq[T2] {
	var zero T2
...
func FilterMap2[T1 any, T2 comparable](seq iter.Seq[T1], f func(T1) (T2, bool)) iter.Seq[T2] {
	return func(yield func(T2) bool) {
		seq(func(v T1) bool {
			if r, ok := f(v); ok {
				return yield(r)
